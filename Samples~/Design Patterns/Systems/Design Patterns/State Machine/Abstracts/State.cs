namespace PawBab.DesignPatterns.FSM
{
    ...
    public abstract class State<TOwner>
    {
        ...
        /// <summary>
        /// Logika reakcji stanu na zdarzenie interakcji.
        /// <para>
        /// Metoda wywoływana przez maszynę stanów w odpowiedzi na zewnętrzny sygnał,
        /// np. użycie obiektu, kliknięcie, naciśnięcie przycisku lub inne zdarzenie
        /// wejściowe.
        /// </para>
        /// <para>
        /// Domyślna implementacja nie wykonuje żadnej operacji. Konkretne stany
        /// powinny nadpisać tę metodę, jeśli mają reagować na interakcję.
        /// </para>
        /// </summary>
