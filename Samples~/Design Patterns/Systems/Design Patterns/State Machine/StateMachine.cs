...
namespace PawBab.DesignPatterns.FSM
{
    ...
    public class StateMachine<TOwner>
    {
        ...
        /// <summary>
        /// Deleguje zdarzenie interakcji do aktualnie aktywnego stanu.
        /// <para>
        /// Jeśli istnieje aktywny stan, wywoływana jest jego metoda <c>Interact()</c>.
        /// W przeciwnym wypadku wywołanie jest ignorowane.
        /// </para>
        /// <para>
        /// Metoda może być używana jako zewnętrzny punkt wejścia dla zdarzeń
        /// takich jak kliknięcie, użycie obiektu, naciśnięcie przycisku,
        /// trigger z input systemu itp. Konkretna reakcja zależy wyłącznie
        /// od implementacji bieżącego stanu.
        /// </para>
        /// </summary>
